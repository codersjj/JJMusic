...
__DEFINE__(1641211153415, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1641211153416,"./event-store":1641211153417}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1641211153416, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1641211153417, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1641211153416,"./utils":1641211153418}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1641211153418, function(require, module, exports) {
...
return __REQUIRE__(1641211153415);
})()
